        ...
        <div class="navbar-fixed">
            <nav class="white" role="navigation">
                <div class="nav-wrapper container">
                    <a id="logo-container" href="${appPath('/')}" class="brand-logo"><img src="${appPath('/media/logofactory.svg')}" alt="makers' lab"/></a>
                    ...
                    <ul class="right hide-on-med-and-down">
                        ...
                        <li><a href="${appPath('/equipment.html')}">equipment</a></li>
